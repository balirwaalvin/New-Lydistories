...
import { FiSearch, FiMenu, FiX, FiUser, FiLogOut, FiGrid, FiBookOpen, FiSettings } from 'react-icons/fi';
import './Navbar.css';
    ...
    <nav className="navbar">
      <div className="navbar-inner container">
        ...
        <div className="navbar-actions">
          <button className="btn-icon nav-icon" onClick={() => setSearchOpen(!searchOpen)}>
            <FiSearch />
          </button>
            ...
            <div className="profile-menu">
              ...
              {profileOpen && (
                <div className="profile-dropdown" onClick={() => setProfileOpen(false)}>
                  ...
                  {isAdmin && <Link to="/admin" className="profile-item"><FiSettings /> Admin Portal</Link>}
          ...
          <button className="btn-icon nav-icon mobile-menu" onClick={() => setMenuOpen(!menuOpen)}>
            {menuOpen ? <FiX /> : <FiMenu />}
          </button>
        </div>
      </div>
